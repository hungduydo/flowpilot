...
export function TemplateModal({ open, onClose }: TemplateModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      {/* Modal */}
      <div className="relative w-full max-w-2xl h-[80vh] mx-4 bg-surface-900 border border-surface-700 rounded-xl shadow-2xl flex flex-col overflow-hidden">
        {/* Header */}
        <div className="flex items-center justify-between px-5 py-3.5 border-b border-surface-800">
          <div>
            ...
            <p className="text-xs text-surface-500 mt-0.5">
              Browse and import community workflow templates to enrich knowledge base
            </p>
          </div>
          <button
            onClick={onClose}
